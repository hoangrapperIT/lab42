package com.byhoangrapper.lab4;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void heloworld(View view) {
        ...
        boolean isMobi = networkInfo.isConnected();
        if (isWifi) {
            Toast.makeText(getApplicationContext(), "Ket Noi WIFI", Toast.LENGTH_SHORT).show();
        }
        if (isMobi) {
            Toast.makeText(getApplicationContext(), " ket NOI 3g MOBI", Toast.LENGTH_SHORT).show();
        }
    }
}